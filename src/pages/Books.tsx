...
export default function Books() {
  ...
  const sorted = [...search.results].sort((a, b) => {
    ...
    switch (sortKey) {
      ...
      case "final":
        return ((a.finalPrice ?? 0) - (b.finalPrice ?? 0)) * dir;
      default:
        return 0;
    }
  });
                  ...
                  sorted.map((book) => (
                    <tr key={book.id} onClick={() => openBook(book)}>
                      ...
                      <td dir="ltr" className="font-medium">
                        ${book.openingPrice.toLocaleString()}
                      </td>
                      <td dir="ltr" className="font-medium">
                        {book.finalPrice ? (
                      ...
                      <td>
                        <span
                          className={`inline-flex px-2 py-0.5 text-xs font-semibold rounded-full ${book.sold ? "" : ""}`}
                          style={
                            book.sold
